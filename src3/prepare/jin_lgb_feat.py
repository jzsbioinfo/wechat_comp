...
save_pickle(train,'../train/data/wechat_algo_data1/train.pkl')
save_pickle(test,'../train/data/wechat_algo_data1/test.pkl')
save_pickle(cols,'../train/data/wechat_algo_data1/cols.pkl')
