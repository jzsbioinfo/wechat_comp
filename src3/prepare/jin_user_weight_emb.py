...
save_pickle(user_date_emd,'../train/data/wechat_algo_data1/user_date_weigh_emd.pkl')
...
save_pickle(emb,'../train/data/wechat_algo_data1/user_weight_emd_{}.pkl'.format(dim))